...
export default function DialogBase({ children: content, dialogOpen, onDialogClose }: DialogProps) {
    ...
    return (
        <div className={`fixed top-0 left-0 z-50 size-full bg-black/20 flex justify-center items-center backdrop-blur-xs 
            ...
            <div ref={modal} className={"bg-white w-full max-w-xl px-9 py-6 rounded-lg border border-stroke"}>
                {content}
            </div>
        </div>
    );
