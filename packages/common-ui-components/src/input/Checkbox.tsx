...
export default function Checkbox({ checked, disabled, value, label, onChange }: CheckboxProps) {
    return (
        <div className="flex gap-4">
            <label className="relative flex items-center">
                ...
                />
                <span className="absolute text-primary opacity-0 peer-checked:opacity-100 top-1/2 left-1/2 
