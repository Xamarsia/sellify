import { CheckboxFilterPropertyValue, RangeFilterPropertyValue } from "./PropertyValues";
...
export class RangeFilterProperty extends FilterProperty {
    ...
    constructor(key: string, min: number, max: number, defaultValue: RangeFilterPropertyValue) {
